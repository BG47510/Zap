...
s = requests.Session()
response = s.get(f'https://hdfauth.ftven.fr/esi/TA?url=https://simulcast-p.ftven.fr/simulcast/France_3/hls_fr3/index.m3u8', headers=headers)
#print(response.text)

source = response.text

lien = source.replace("index", "France_3-avc1_2500000=10001")

lien2 = source.replace("index", "France_3-mp4a_96000_fra=20000")
